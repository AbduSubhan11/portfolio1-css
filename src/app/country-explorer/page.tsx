...
function page() {
  return (
    <div className="countryExplorParent">
      <Image src={country} alt="country"  className={styles.countryeExplorImage} />
      <div className={styles.countryExplrTextParent}>
        ...
        <p className={styles.countryExplrPara3}>
          ...
          <Link href="https://all-rest-countries-info.netlify.app/" className={styles.countryExplrVisitLink}>
            here
          </Link>
          .
        </p>
